...
def home(request):
    ...
    technews = Technews.objects.all()[:12]
    ...
    #     # print("ImgURL: {}".format(i['urlToImage']))
    #     # print("Content: {}".format(i['content']))

    #     # print("---------------------------------------------------------")
    #     Technews.objects.create(title = title, content = content, image_url = image_url)
    #     print('technews title stored on DB ==={}'.format(title))
    # print("-------------------DONE -----------------------------------")    
    return render(request, 'my_app/home.html', {'posts':posts, 'technews': technews} )
